        ...
        <section class="register-photo" style="border-color: rgb(33, 37, 41);background: rgb(241, 247, 252);">
            ...
            <div class="form-container">
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-3"><input class="form-control" type="text" name="fullname" placeholder="fullname" required></div>
                    <div class="mb-3"><input class="form-control" type="text" name="username" placeholder="username" required></div>
                    <div class="mb-3"><input class="form-control" type="text" name="password" placeholder="password" required></div>
                    <div class="mb-3"><input class="form-control" type="text" name="address" placeholder="address" required></div>
                    <div class="mb-3">
                        <b>Gender:  </b>
                        <select name="gender" style="margin-top : 20px;" required>
                    ...
                    <div class="mb-3">
                        <b>Account for:  </b>
                        <select name="accounttype" style="margin-top : 20px;" required>
                            <option value="" disabled selected>Choose Option</option>
