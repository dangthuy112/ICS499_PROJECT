...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 28, 2021 at 05:27 PM
...
(1, 'Math', 480, 'Current Semester', 'TH', 'Metro State  room1', 'In person', '6:30PM - 9:30PM', 'Algebra'),
(2, 'Math', 580, 'Current Semester', 'W', 'Metro State  room1', 'In person', '6:30PM - 9:30PM', 'Advance Algebra'),
(3, 'Math', 680, 'Current Semester', 'T', 'Metro State  room1', 'In person', '6:30PM - 9:30PM', 'Calculus 1'),
(4, 'Math', 1000, 'Current Semester', 'M', 'Metro State  room1', 'In person', '6:30PM - 9:30PM', 'Calculus 2'),
(5, 'ICS', 141, 'Current Semester', 'M W F ', 'Online studing', 'Online', '6:30PM - 9:30PM', 'Java Basic'),
(6, 'ICS', 380, 'Current Semester', 'W', 'Online studing', 'Online', '6:30PM - 9:30PM', 'Java 8'),
(7, 'ICS', 440, 'Current Semester', 'T', 'Online studing', 'Online', '6:30PM - 9:30PM', 'Mutiple Thread'),
(8, 'ICS', 449, 'Current Semester', 'M', 'Online studing', 'Online', '6:30PM - 9:30PM', 'Capston Project'),
(9, 'ESOL', 122, 'Current Semester', 'T TH ', 'Metro State  room 3', 'In Person', '10:00AM - 2:00PM', 'Level 1 '),
(10, 'ESOL', 124, 'Current Semester', 'W', 'Metro State  room 3', 'In person', '10:00AM - 2:00PM', 'Level 2'),
(11, 'ESOL', 180, 'Current Semester', 'T', 'Metro State  room 3', 'In person', '10:00AM - 2:00PM', 'Level 3'),
(12, 'ESOL', 200, 'Current Semester', 'M', 'Metro State  room 3', 'In person', '10:00AM - 2:00PM', 'Level 4'),
(13, 'Math', 480, 'Next Semester', 'TH', 'Metro State  room1', 'In person', '6:30PM - 9:30PM', 'Algebra'),
(14, 'Math', 580, 'Next Semester', 'W', 'Metro State  room1', 'In person', '6:30PM - 9:30PM', 'Advance Algebra'),
(15, 'Math', 680, 'Next Semester', 'T', 'Metro State  room1', 'In person', '6:30PM - 9:30PM', 'Calculus 1'),
(16, 'Math', 1000, 'Next Semester', 'M', 'Metro State  room1', 'In person', '6:30PM - 9:30PM', 'Calculus 2'),
(17, 'ICS', 340, 'Next Semester', 'TH', 'Online studing', 'Online', '6:30PM - 9:30PM', 'Java Basic'),
(18, 'ICS', 380, 'Next Semester', 'W', 'Online studing', 'Online', '6:30PM - 9:30PM', 'Java 8'),
(19, 'ICS', 440, 'Next Semester', 'T', 'Online studing', 'Online', '6:30PM - 9:30PM', 'Mutiple Thread'),
(20, 'ICS', 449, 'Next Semester', 'M', 'Online studing', 'Online', '6:30PM - 9:30PM', 'Capston Project'),
(21, 'ESOL', 122, 'Next Semester', 'TH', 'Metro State  room 3', 'In person', '10:00AM - 2:00PM', 'Level 1 '),
(22, 'ESOL', 124, 'Next Semester', 'W', 'Metro State  room 3', 'In person', '10:00AM - 2:00PM', 'Level 2'),
(23, 'ESOL', 180, 'Next Semester', 'T', 'Metro State  room 3', 'In person', '10:00AM - 2:00PM', 'Level 3'),
(24, 'ESOL', 200, 'Next Semester', 'M', 'Metro State  room 3', 'In person', '10:00AM - 2:00PM', 'Level 4'),
(25, 'BIOL', 240, 'Current Semester', 'T TH ', 'Main Campus', 'In Person', '6:00PM - 9:30PM', 'Biology 2');
...
INSERT INTO `instructors` (`instructorID`, `fullname`, `gender`, `address`) VALUES
(1, 'Adam Washinton', 'male', '3304 Anthony Avenue\nMerkel, TX 79536'),
(2, 'Donald Land', 'male', '113 Duff Avenue\nSouth Burlington, VT 05403'),
(3, 'Carol Yap', 'female', '31 Elk Creek Road\nPeachtree City, GA 30269'),
(4, 'Brian William', 'male', '391 Par Drive\nPomona, CA 91766');
...
INSERT INTO `students` (`studentID`, `fullname`, `gender`, `address`) VALUES
(1, 'Simon Phipps', 'male', '283 Wescam Court\nHawthorne, NV 89415'),
(2, 'Alvin Huling', 'male', '465 Martha Street\nToyei, AZ 86515'),
(3, 'Theo Blunt', 'male', '1872 Mahlon Street\nSouthfield, MI 48075'),
(4, 'Brittany Harrington', 'female', '1048 Jarvis Street\nBuffalo, NY 14211'),
(5, 'Jenette Luedtke', 'female', '1045 Werninger Street\nPearland, TX 77581'),
(6, 'Elenor Rankins', 'female', '1242 Doctors Drive\nLos Angeles, CA 90066'),
(7, 'Stu Gilbert', 'male', '4365 Wood Street\nMetairie, LA 70007'),
(8, 'Thuy Vo', 'male', '1845 Raoul Wallenberg Place\nGreenwich, CT 068'),
(9, 'Trung Pham', 'male', '4391 Hannah Street\nAsheville, NC 28801'),
(10, 'Aziz Moalim', 'male', '4472 Eagle Street\nCarbondale, IL 62901'),
(11, 'Vincent Some', 'female', '1714 Holden Street\nSan Diego, CA 92102');
...
(28, 'carolyap', 'bigcarol', NULL, 3, NULL, 2),
(29, 'simonphipps', 'simonphipps431', 1, NULL, NULL, 3),
(30, 'alvinhuling', 'alvinhuling564', 2, NULL, NULL, 3),
(31, 'theoblunt', 'theoblunt7523', 3, NULL, NULL, 3),
(32, 'brittanyharrington', 'brittanyharrington7543', 4, NULL, NULL, 3),
(33, 'jenlue', 'jenlue312', 5, NULL, NULL, 3),
(34, 'elenorrankins', 'elenorrankins31565', 6, NULL, NULL, 3),
(35, 'stugilbert', 'stugilbert', 7, NULL, NULL, 3),
(36, 'dangthuyvo', 'dtf69', 8, NULL, NULL, 3),
(37, 'azizmoalim', 'mylittleponyxoxo', 10, NULL, NULL, 3),
(38, 'vincentsome', 'vincentsomeeee', 11, NULL, NULL, 3),
(39, 'donaldlando', 'donaldlando665', NULL, 2, NULL, 2),
(40, 'brianwilliam', 'brianwilliam563', NULL, 4, NULL, 2);
...
ALTER TABLE `note`
  ...
  ADD KEY `courseID_note` (`courseID_note`),
  ADD KEY `studentID_note` (`studentID_note`);
...
--
ALTER TABLE `announcement`
  ADD CONSTRAINT `courseID_ann` FOREIGN KEY (`courseID_ann`) REFERENCES `courses` (`courseID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `assignment`
--
ALTER TABLE `assignment`
  ADD CONSTRAINT `courseID_ass` FOREIGN KEY (`courseID_ass`) REFERENCES `courses` (`courseID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `grades`
--
ALTER TABLE `grades`
  ADD CONSTRAINT `courseID_grade` FOREIGN KEY (`courseID_grade`) REFERENCES `courses` (`courseID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `studentID_grade` FOREIGN KEY (`studentID_grade`) REFERENCES `students` (`studentID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `note`
  ADD CONSTRAINT `note_ibfk_1` FOREIGN KEY (`courseID_note`) REFERENCES `courses` (`courseID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `note_ibfk_2` FOREIGN KEY (`studentID_note`) REFERENCES `students` (`studentID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `student_enroll`
--
ALTER TABLE `student_enroll`
  ADD CONSTRAINT `student_enroll_ibfk_1` FOREIGN KEY (`studentID_enroll`) REFERENCES `students` (`studentID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `student_enroll_ibfk_2` FOREIGN KEY (`courseID_enroll`) REFERENCES `courses` (`courseID`) ON DELETE CASCADE ON UPDATE CASCADE;
